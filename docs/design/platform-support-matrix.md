...
> **2026-09-25 当前源码同步边界**：`3e32ddcc08f01b2933f54b8ea498edbfb98dd0d4` 是当前源码锚；历史能力字段保持，原始能力证据仍为 `NOT_REVERIFIED`，本次同步不增加平台或发布批准。a5 SDK与手动模型证据、原CI传输失败及新候选待验范围见[U29执行记录](../plans/2026-09-24-017-foundation-integration-execution.md#2026-09-25-证据传输修复与实际终态续记)；生成边界见[平台状态](../status/platform-status.md)。
