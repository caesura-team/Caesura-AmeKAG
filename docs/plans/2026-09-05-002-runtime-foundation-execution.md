...
路线图保留 U1–U29，底层优先，Studio 暂停。2026-09-08 用户明确恢复继续开发，取代此前“U11 后暂停”的安排；U11–U16 已交付，当前推进 U17 输入、音频与前后台生命周期。Expo 新运行受配额限制，用户已要求先继续其余开发。完整路线图尚未完成，本记录不把排期当成完成证据。
...
| U17 | 执行中 | 暂停原因交错与voice_wait有真实执行红绿回归，输入事件回归已复现；触摸/IME/完成所有权、实际混音和完整门禁待完成，详见2026-09-12-008 |
| U18–U26 | 待继续执行 | 按唯一计划逐项实现和验收；已有Apple准备不代替真实设备/SDK/最终包证明 |
