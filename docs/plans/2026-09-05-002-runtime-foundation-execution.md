...
| U15 | 实现与本机回归进行中 | 截图票据/代次、单次呈现、异步保存取消及协程关闭已接通；Cpp1324与Lua147/46 preflight通过，真实D3D11 renderer56/RPC70项通过。最终冻结门禁及Web性能仍未通过完整候选验收，详见2026-09-08-005 |
...
| U27 | 诊断准备中 | 既有性能门槛保留，固定U13/U14配对未建立版本回退关联；针对共同快照与跨语言成本准备一次有界profile，不把准备或插桩结果当预算通过 |
