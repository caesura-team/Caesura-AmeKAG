...
路线图保留 U1–U29，底层优先，Studio 暂停。2026-09-08 用户明确恢复继续开发，取代此前“U11 后暂停”的安排；U11–U14 已交付，当前推进 U15 截图生命周期及真实图像检查中发现的 U16 文字缺损。Expo 新运行受配额限制，用户已要求先继续其余开发。完整路线图尚未完成，本记录不把排期当成完成证据。
...
| U15 | 本机候选整合中 | 截图票据/代次、单次呈现、异步保存取消及协程关闭已接通；68a6e74d完整Debug profile与严格核验通过，Cpp1325/1325、Lua147/46、CTest25通过+1预声明AI跳过，D3D11修复字形后共136项通过。后续U27源码已取得a699bc5c完整Web511/511，最新原生整合和候选CI仍待完成，详见2026-09-08-005与2026-09-09-006 |
| U16 | 缓存字形缺损已修复，其余图像能力待验 | 旧实现几何2项失败、GPU新增10项字形检查失败；一行索引修复后几何11/11及D3D11共136项通过，独立FreeType原生334/334与缩略图94/94像素命中；其他图像能力按原计划执行 |
