...
路线图保留 U1–U29，底层优先，Studio 暂停。2026-09-08 用户明确恢复继续开发，取代此前“U11 后暂停”的安排；U11–U15 已交付，当前推进 U16 原生图像回归及其确证缺陷。Expo 新运行受配额限制，用户已要求先继续其余开发。完整路线图尚未完成，本记录不把排期当成完成证据。
...
| U16 | 实际两后端图像与完整本机门禁通过，候选CI待完成 | v4固定矩阵D3D11/GL共18/18、82张截图通过；物理尺寸恢复20项及U15 renderer59/RPC77/fill34通过；805bb3d完整Debug、C++1333/1333、Lua147/46、CTest27通过/1项允许AI跳过及严格证据核验通过；PR #19正在修复CI的Metal解析及macOS夹具路径问题，详见2026-09-09-007 |
| U17–U26 | 待继续执行 | 按唯一计划逐项实现和验收；已有Apple准备不代替真实设备/SDK/最终包证明 |
