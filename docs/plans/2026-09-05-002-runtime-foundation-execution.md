...
路线图保留 U1–U29，底层优先，Studio 暂停。U11 已合并，master `35245667` 的 CI `34180028627` 已确认10/10全部成功。2026-09-08 用户明确恢复继续开发，取代此前“U11 后暂停”的安排；U12已通过候选门禁并合并，当前推进U13。完整路线图尚未完成，本记录不把排期当成完成证据。
...
| U14 | 本机最终验收通过，候选CI待核验 | 缓存格式/语义/schema、冷入口、隔离token、全场景preflight、最终包及重名输入完整性完成真实回归。干净c227dcc7完整Web506/506、Node包CLI6/6、Debug profile11/11、Cpp1292/1292、Lua147/45、CTest25通过+1预声明AI跳过及严格证据核验通过；详见2026-09-08-004记录 |
| U15–U29 | 待执行 | 按唯一计划依赖继续推进，Studio继续暂停；U2 Apple渠道按用户指定接入Expo EAS |
