...
| U12 | 已合并；master打包核验中 | 最终干净daec64bf的Windows Debug profile 11/11、Cpp1292/1292、Lua147/43、CTest25通过+1预声明AI跳过，collect/严格verify通过；相同Web代码完整496/496且原预算通过。CI34204541141的7项验证任务成功、3项PR打包按规则跳过；PR #13合并到master99a65d16，masterCI34206114925单独核验 |
| U13 | 本机最终验收通过，候选CI待核验 | AST标签/参数差异真实RED后修复；六组语料36次原生+12次Web运行事件一致。干净43394fa0的Web498/498、完整Debug profile11/11、Cpp1292/1292、Lua147/44、CTest25通过+1预声明AI跳过及严格证据核验通过；详见2026-09-08-002执行记录 |
| U14–U29 | 待执行 | 按唯一计划依赖继续推进，Studio继续暂停 |
