...
路线图保留 U1–U29，底层优先，Studio 暂停。2026-09-08 用户明确恢复继续开发，取代此前“U11 后暂停”的安排；U11–U17 已交付，当前推进 U18 运行错误与底层RPC退出/超时语义。Expo 新运行受配额限制，用户已要求先继续其余开发。完整路线图尚未完成，本记录不把排期当成完成证据。
