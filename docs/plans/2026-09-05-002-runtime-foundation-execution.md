...
| U12 | 本机验收通过，交付中 | 干净6acb6aea的完整Windows Debug profile 11/11、Cpp1292/1292、Lua147/43、CTest25通过+1预声明AI跳过；完整Web496/496，原性能预算通过；collect与严格verify通过。组织仓库当前候选CI与主分支合并待完成 |
| U13 | 准备中 | 真实runner的源/AST/缓存探索已复现AST标签未命中；正式共享语料和Web bundle对照尚未实施，不计作验收通过 |
