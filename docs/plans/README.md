...
2026-09-08 接续开发核对见 [U12 交接记录](2026-09-08-001-u12-resume-handoff.md)：U11 对应 master CI 已在线复核；U12 宏/选择、资源准备及真实迟到完成已实现并通过定向回归，展示稳定点61项和Lua主147/147、隔离43/43通过；最终完整原生/CTest与Web验收及交付仍在进行。
