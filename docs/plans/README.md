...
2026-09-13：U18 PR #21已合并9b269ab7。[U19目标能力](2026-09-12-010-target-capabilities-execution.md)的2dfe451e代码候选完成严格原生门禁（1397 C++、Lua147/54、CTest32通过/1可选跳过）、完整Web531/531、Chrome实际包14项与桌面包启动正反验证，七项执行CI成功；PR #22待文档CI/合并。接续准备U20 Web音频，U20–U29及此前未完成项未缩减。
