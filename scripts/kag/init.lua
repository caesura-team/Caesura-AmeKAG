...
local capability_json = require("capability_json") -- strict declaration codec; preload before lockdown
local capability_catalog = require("capability_catalog") -- generated trusted catalog data
local target_capabilities = require("target_capabilities") -- policy and target predicates
local capability_runtime = require("capability_runtime") -- captured host and private project policy
local capability_backend = require("capability_backend") -- operation result wrappers
